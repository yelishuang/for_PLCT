...
%define RosPkgName      sensor-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        4.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        A package containing some sensor data related message and service definitions.
...
BuildRequires: ros-%{ros_distro}-rosidl-cmake
%endif
