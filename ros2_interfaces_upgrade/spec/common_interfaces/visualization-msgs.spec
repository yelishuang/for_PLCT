...
%define RosPkgName      visualization-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        4.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        A package containing some visualization related message definitions.
...
%description
A package containing some visualization related message definitions.
