...
Requires: ros-%{ros_distro}-hpp-fcl
...
BuildRequires: ros-%{ros_distro}-hpp-fcl
BuildRequires: git
...
%changelog
* Sun Dec 22 2024 Justin Carpentier justin.carpentier@inria.fr - 1-None
