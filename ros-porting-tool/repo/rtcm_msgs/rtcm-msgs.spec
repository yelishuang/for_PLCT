...
%define RosPkgName      rtcm-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        The rtcm_msgs package contains messages related to data in the RTCM format.
...
%changelog
* Sun Dec 22 2024 Marek Materzok tilk@tilk.eu - 1-None
