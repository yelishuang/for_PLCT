...
%define RosPkgName      kobuki-velocity-smoother

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS kobuki-velocity-smoother package
...
BuildRequires: ros-%{ros_distro}-ros2test
%endif
...
%changelog
* Sun Dec 22 2024 Jihoon Lee jihoonl@yujinrobot.com - 1-None
