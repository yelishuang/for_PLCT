...
%define RosPkgName      warehouse-ros-sqlite

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS warehouse-ros-sqlite package

Url:            http://ros.org/wiki/warehouse_ros
License:        BSD
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-warehouse-ros
Requires: ros-%{ros_distro}-class-loader
Requires: ros-%{ros_distro}-rclcpp
Requires: ros-%{ros_distro}-sqlite3-vendor
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: ros-%{ros_distro}-warehouse-ros
BuildRequires: ros-%{ros_distro}-class-loader
BuildRequires: ros-%{ros_distro}-rclcpp
BuildRequires: ros-%{ros_distro}-sqlite3-vendor
...
%changelog
* Sun Dec 22 2024 MoveIt Release Team moveit_releasers@googlegroups.com - 1-None
