...
Summary:        ROS py-trees-ros package

Url:            https://py-trees-ros.readthedocs.io/en/release-1.2.x/
License:        BSD
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-py-trees
Requires: ros-%{ros_distro}-py-trees-ros-interfaces
...
Requires: ros-%{ros_distro}-unique-identifier-msgs
Requires: ros-%{ros_distro}-geometry-msgs
Requires: ros-%{ros_distro}-sensor-msgs
Requires: ros-%{ros_distro}-tf2-ros-py
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: ros-%{ros_distro}-py-trees
BuildRequires: ros-%{ros_distro}-py-trees-ros-interfaces
...
BuildRequires: ros-%{ros_distro}-unique-identifier-msgs
BuildRequires: ros-%{ros_distro}-geometry-msgs
BuildRequires: ros-%{ros_distro}-sensor-msgs
BuildRequires: ros-%{ros_distro}-tf2-ros-py
