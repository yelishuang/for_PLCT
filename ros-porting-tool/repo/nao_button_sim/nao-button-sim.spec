...
%define RosPkgName      nao-button-sim

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Allows simulating button presses through command line interface

License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz

Requires: nao_lola_sensor_msgs
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: nao_lola_sensor_msgs
