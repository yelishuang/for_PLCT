...
%define RosPkgName      domain-bridge

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS 2 Domain Bridge
...
BuildRequires: ros-%{ros_distro}-rmw-connextdds
BuildRequires: ros-%{ros_distro}-rmw-cyclonedds-cpp
BuildRequires: ros-%{ros_distro}-rmw-fastrtps-cpp
%endif
...
%changelog
* Sun Dec 22 2024 Jacob Perron jacob@openrobotics.org - 1-None
