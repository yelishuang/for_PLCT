...
%define RosPkgName      object-recognition-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Object_recognition_msgs contains the ROS message and the actionlib definition used in object_recognition_core
...
%changelog
* Sun Dec 22 2024 Vincent Rabaud vincent.rabaud@gmail.com - 1-None
