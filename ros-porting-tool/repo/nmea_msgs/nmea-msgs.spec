...
%define RosPkgName      nmea-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        The nmea_msgs package contains messages related to data in the NMEA format.
...
%changelog
* Sun Dec 22 2024 Ed Venator evenator@gmail.com - 1-None
