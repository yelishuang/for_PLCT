...
%define RosPkgName      neo-simulation2

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS-2 Simulation packages for neobotix robots
...
Requires: ros-%{ros_distro}-slam-toolbox
Requires: neo_nav2_bringup
Requires: ros-%{ros_distro}-gazebo-ros
Requires: ur_simulation_gazebo
Requires: ros-%{ros_distro}-ur-description
Requires: neo_ur_moveit_config
Requires: elite_description
Requires: elite_gazebo
...
%changelog
* Sun Dec 22 2024 Padmanabhan Pradheep padmanabhan@neobotix.de - 1-None
