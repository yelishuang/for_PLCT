...
%define RosPkgName      slider-publisher

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        This packages proposes a slider-based publisher node similar to the joint_state_publisher, but that can publish any type of message or call services.
...
%changelog
* Sun Dec 22 2024 Olivier Kermorgant olivier.kermorgant@ec-nantes.fr - 1-None
