...
%define RosPkgName      rqt-tf-tree

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        rqt_tf_tree provides a GUI plugin for visualizing the ROS TF frame tree.
...
%changelog
* Sun Dec 22 2024 Isaac I.Y. Saito gm130s@gmail.com - 1-None
