...
%define RosPkgName      async-web-server-cpp

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Asynchronous Web/WebSocket Server in C++
...
%changelog
* Sun Dec 22 2024 Timo Röhling timo.roehling@fkie.fraunhofer.de - 1-None
