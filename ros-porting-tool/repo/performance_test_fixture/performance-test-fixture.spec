...
%define RosPkgName      performance-test-fixture

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS performance-test-fixture package

License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-google-benchmark-vendor
Requires: ros-%{ros_distro}-osrf-testing-tools-cpp
Requires: ros-%{ros_distro}-ament-cmake-google-benchmark
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: ros-%{ros_distro}-google-benchmark-vendor
BuildRequires: ros-%{ros_distro}-osrf-testing-tools-cpp
BuildRequires: ros-%{ros_distro}-ament-cmake-core
BuildRequires: ros-%{ros_distro}-ament-cmake-export-dependencies
BuildRequires: ros-%{ros_distro}-ament-cmake-export-targets
BuildRequires: ros-%{ros_distro}-ament-cmake-test
...
%changelog
* Sun Dec 22 2024 Alejandro Hernandez Cordero alejandro@openrobotics.org - 1-None
