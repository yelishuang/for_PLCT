...
%define RosPkgName      swri-console

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS swri-console package
...
Requires: ros-%{ros_distro}-rosbag2-storage-mcap
...
%changelog
* Sun Dec 22 2024 Southwest Research Institute swri-robotics@swri.org - 1-None
