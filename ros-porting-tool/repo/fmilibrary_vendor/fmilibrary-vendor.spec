...
%define RosPkgName      fmilibrary-vendor

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Wrapper (aka vendor package) around the FMILibrary by Modelon AB (JModelica.org)

Url:            https://jmodelica.org/
License:        BSD-3-Clause
Source0:        %{name}_%{version}.orig.tar.gz
SOURCE1: fmi-library-2.2.3.tar.gz
...
%changelog
* Sun Dec 22 2024 Ralph Lange ralph.lange@de.bosch.com - 1-None
