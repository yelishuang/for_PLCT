...
%define RosPkgName      nerian-stereo

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Driver node for ROS 2 for Scarlet, SceneScan and SP1 stereo vision sensors by Nerian Vision GmbH
...
%changelog
* Sun Dec 22 2024 Konstantin Schauwecker konstantin.schauwecker@nerian.com - 1-None
