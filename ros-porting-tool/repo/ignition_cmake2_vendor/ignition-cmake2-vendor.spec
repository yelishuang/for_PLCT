...
%define RosPkgName      ignition-cmake2-vendor

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        This package provides the Ignition CMake 2.x library.

Url:            https://github.com/ignitionrobotics/ign-cmake
License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz
Source1:        ignition-cmake2_2.8.0.tar.gz

Patch0: 0-ignition-cmake2-vendor-change-cmake-download.patch
