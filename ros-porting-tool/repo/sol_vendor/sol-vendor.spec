...
%define RosPkgName      sol-vendor

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        vendor package for the sol2 library

License:        Apache License 2.0 and MIT
Source0:        %{name}_%{version}.orig.tar.gz
Source1:        sol2.tar.gz
Source2:        lua-5.4.4.tar.gz
Source3:        0-sol2-change-cmake-download.patch

Patch0:         0-sol-vendor-change-cmake-download.patch
...
%changelog
* Sun Dec 22 2024 Kotaro Yoshimoto pythagora.yoshimoto@gmail.com - 1-None
