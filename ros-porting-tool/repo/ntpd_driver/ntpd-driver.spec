...
%define RosPkgName      ntpd-driver

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS ntpd-driver package
...
This node sends time via SHM interface.
...
%changelog
* Sun Dec 22 2024 Vladimir Ermakov vooon341@gmail.com - 1-None
