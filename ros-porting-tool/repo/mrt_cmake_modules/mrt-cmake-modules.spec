...
%define RosPkgName      mrt-cmake-modules

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        CMake Functions and Modules for automating CMake

Url:            http://wiki.ros.org/mrt_cmake_modules
License:        BSD
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-gtest-vendor
...
%changelog
* Sun Dec 22 2024 Kevin Rösch kevin.roesch@kit.edu - 1-None
