...
%define RosPkgName      geometric-shapes

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        This package contains generic definitions of geometric shapes and bodies.
...
BuildRequires: ros-%{ros_distro}-ament-lint-cmake
...
%changelog
* Sun Dec 22 2024 Tyler Weaver tyler@picknik.ai - 1-None
