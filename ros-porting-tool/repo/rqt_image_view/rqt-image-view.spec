...
%define RosPkgName      rqt-image-view

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        rqt_image_view provides a GUI plugin for displaying images using image_transport.
...
Requires: ros-%{ros_distro}-rqt-gui-cpp
...
BuildRequires: ros-%{ros_distro}-rqt-gui
BuildRequires: ros-%{ros_distro}-rqt-gui-cpp
...
%changelog
* Sun Dec 22 2024 Mabel Zhang mabel@openrobotics.org - 1-None
