...
%define RosPkgName      backward-ros

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        The backward_ros package is a ros wrapper of backward-cpp from https://github.com/bombela/backward-cpp 
...
%changelog
* Sun Dec 22 2024 Victor López victor.lopez@pal-robotics.com - 1-None
