...
%define RosPkgName      zmqpp-vendor

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Vendor package for zmqpp

License:        Apache License 2.0 and Mozilla Public License 2.0
Source0:        %{name}_%{version}.orig.tar.gz
Source1:        zmqpp.tar.gz

Patch0:         0-zmqpp-vendor-change-cmake-download.patch
...
%changelog
* Sun Dec 22 2024 Masaya Kataoka masaya.kataoka@tier4.jp - 1-None
