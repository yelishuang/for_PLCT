...
%define RosPkgName      grbl-ros

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS2 package to interface with a GRBL serial device

License:        MIT
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-rclpy
Requires: ros-%{ros_distro}-grbl-msgs
Requires: ros-%{ros_distro}-std-msgs
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: ros-%{ros_distro}-rclpy
BuildRequires: ros-%{ros_distro}-grbl-msgs
