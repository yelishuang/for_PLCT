...
%define RosPkgName      nao-lola

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Packages that allow communicating with the NAO’s Lola middle-ware.

License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-rclcpp
Requires: ros-%{ros_distro}-nao-command-msgs
Requires: ros-%{ros_distro}-nao-sensor-msgs
Requires: boost-devel
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: ros-%{ros_distro}-rclcpp
BuildRequires: ros-%{ros_distro}-nao-command-msgs
BuildRequires: ros-%{ros_distro}-nao-sensor-msgs
...
%changelog
* Sun Dec 22 2024 ijnek kenjibrameld@gmail.com - 1-None
