...
%define RosPkgName      bag2-to-image

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        The bag2_to_image package
...
%if 0%{?with_tests}
BuildRequires: ros-%{ros_distro}-ament-cmake-clang-format
...
%changelog
* Sun Dec 22 2024 Daisuke Nishimatsu nishimarudai@gmail.com - 1-None
