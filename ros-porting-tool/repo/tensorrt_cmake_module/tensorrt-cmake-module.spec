...
%define RosPkgName      tensorrt-cmake-module

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Exports a CMake module to find TensorRT.
...
%changelog
* Sun Dec 22 2024 Daisuke Nishimatsu daisuke.nishimatsu@tier4.jp - 1-None
