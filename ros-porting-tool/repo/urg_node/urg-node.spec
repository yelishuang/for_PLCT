...
Requires: ros-%{ros_distro}-laser-proc
...
Requires: ros-%{ros_distro}-urg-c
Requires: ros-%{ros_distro}-urg-node-msgs
...
BuildRequires: ros-%{ros_distro}-laser-proc
...
BuildRequires: ros-%{ros_distro}-urg-c
BuildRequires: ros-%{ros_distro}-urg-node-msgs
...
%changelog
* Sun Dec 22 2024 Michael Ferguson mfergs7@gmail.com - 1-None
