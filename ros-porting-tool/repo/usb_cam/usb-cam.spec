...
%define RosPkgName      usb-cam

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        A ROS Driver for V4L USB Cameras

Url:            http://wiki.ros.org/usb_cam
License:        BSD
Source0:        %{name}_%{version}.orig.tar.gz
Patch0:         0-usb-cam-fix-include-not-found.patch
...
Requires: ros-%{ros_distro}-camera-info-manager
Requires: ros-%{ros_distro}-builtin-interfaces
Requires: ros-%{ros_distro}-image-transport
Requires: ros-%{ros_distro}-image-transport-plugins
Requires: v4l-utils
Requires: ffmpeg
...
BuildRequires: ros-%{ros_distro}-camera-info-manager
BuildRequires: ros-%{ros_distro}-builtin-interfaces
BuildRequires: ros-%{ros_distro}-image-transport
BuildRequires: ros-%{ros_distro}-image-transport-plugins
...
%changelog
* Sun Dec 22 2024 Evan Flynn evanflynn.msu@gmail.com - 1-None
