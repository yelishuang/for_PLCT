...
%define RosPkgName      control-toolbox

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        The control toolbox contains modules that are useful across all controllers.
...
%changelog
* Sun Dec 22 2024 Bence Magyar bence.magyar.robotics@gmail.com - 1-None
