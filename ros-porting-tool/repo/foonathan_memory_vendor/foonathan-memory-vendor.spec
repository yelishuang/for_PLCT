...
%define RosPkgName      foonathan-memory-vendor

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Foonathan/memory vendor package for Fast-RTPS.

License:        Apache License 2.0 and zlib License
...
%changelog
* Sun Dec 22 2024 Miguel Company miguelcompany@eprosima.com - 1-None
