...
%define RosPkgName      foxglove-bridge

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS Foxglove Bridge
...
%changelog
* Sun Dec 22 2024 Hans-Joachim Krauch achim@foxglove.dev - 1-None
