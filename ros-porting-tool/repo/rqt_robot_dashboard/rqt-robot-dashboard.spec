...
%define RosPkgName      rqt-robot-dashboard

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        rqt_robot_dashboard provides an infrastructure for building robot dashboard plugins in rqt.
...
Requires: ros-%{ros_distro}-rqt-robot-monitor
...
%changelog
* Sun Dec 22 2024 Aaron Blasdel ablasdel@gmail.com - 1-None
