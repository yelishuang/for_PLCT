...
%define RosPkgName      pointcloud-to-laserscan

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Converts a 3D Point Cloud into a 2D laser scan. This is useful for making devices like the Kinect appear like a laser scanner for 2D-based algorithms (e.g. laser-based SLAM).
...
BuildRequires: ros-%{ros_distro}-ament-cmake-pep257
...
%changelog
* Sun Dec 22 2024 Paul Bovbel paul@bovbel.com - 1-None
