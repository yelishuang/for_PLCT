...
%define RosPkgName      sick-safetyscanners2

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS2 Driver for the SICK safetyscanners
...
Requires: ros-%{ros_distro}-sick-safetyscanners-base
Requires: ros-%{ros_distro}-sick-safetyscanners2-interfaces
...
BuildRequires: ros-%{ros_distro}-sick-safetyscanners-base
BuildRequires: ros-%{ros_distro}-sick-safetyscanners2-interfaces
...
BuildRequires: liburdfdom-tools
...
%changelog
* Sun Dec 22 2024 Lennart Puck puck@fzi.de - 1-None
