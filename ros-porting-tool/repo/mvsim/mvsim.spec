...
%define RosPkgName      mvsim

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        A lightweight multivehicle simulation framework.
...
Requires: mrpt_libgui
Requires: mrpt_libmaps
Requires: mrpt_libposes
Requires: mrpt_libros_bridge
Requires: mrpt_libtclap
...
Requires: wget
Requires: ros-%{ros_distro}-ros2launch
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: boost-devel
BuildRequires: cppzmq-devel
BuildRequires: mrpt_libgui
BuildRequires: mrpt_libmaps
BuildRequires: mrpt_libposes
BuildRequires: mrpt_libros_bridge
BuildRequires: mrpt_libtclap
...
%changelog
* Sun Dec 22 2024 Jose-Luis Blanco-Claraco jlblanco@ual.es - 1-None
