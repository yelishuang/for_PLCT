...
%define RosPkgName      libstatistics-collector

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Lightweight aggregation utilities to collect statistics and measure message metrics.
...
%changelog
* Sun Dec 22 2024 ROS Tooling Working Group ros-tooling@googlegroups.com - 1-None
