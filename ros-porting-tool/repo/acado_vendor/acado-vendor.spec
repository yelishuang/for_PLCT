...
%define RosPkgName      acado-vendor

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ament package for ACADO toolkit for MPC code generation
...
%changelog
* Sun Dec 22 2024 Christopher Ho christopherj.ho@gmail.com - 1-None
