...
%define RosPkgName      aws-robomaker-small-warehouse-world

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS aws-robomaker-small-warehouse-world package
...
Requires: gazebo
Requires: ros-%{ros_distro}-gazebo-plugins
...
%changelog
* Sun Dec 22 2024 AWS RoboMaker ros-contributions@amazon.com - 1-None
