...
%define RosPkgName      message-filters

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS message-filters package

Url:            https://github.com/intel/ros2_message_filters
License:        BSD
...
%changelog
* Sun Dec 22 2024 Ethan Gao ethan.gao@linux.intel.com - 1-None
