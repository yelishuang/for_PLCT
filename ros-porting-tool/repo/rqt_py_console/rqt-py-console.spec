...
%define RosPkgName      rqt-py-console

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        rqt_py_console is a Python GUI plugin providing an interactive Python console.
...
%changelog
* Sun Dec 22 2024 Dorian Scholz scholz@sim.tu-darmstadt.de - 1-None
