...
%define RosPkgName      rc-genicam-driver

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Driver for rc_visard and rc_cube from Roboception GmbH
...
Requires: ros-%{ros_distro}-rc-common-msgs
Requires: ros-%{ros_distro}-rc-genicam-api
...
BuildRequires: ros-%{ros_distro}-rc-common-msgs
BuildRequires: ros-%{ros_distro}-rc-genicam-api
...
%changelog
* Sun Dec 22 2024 Felix Ruess felix.ruess@roboception.de - 1-None
