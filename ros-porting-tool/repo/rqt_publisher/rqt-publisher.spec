...
%define RosPkgName      rqt-publisher

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        rqt_publisher provides a GUI plugin for publishing arbitrary messages with fixed or computed field values.
...
Requires: ros-%{ros_distro}-qt-gui-py-common
...
%changelog
* Sun Dec 22 2024 Dirk Thomas dthomas@osrfoundation.org - 1-None
