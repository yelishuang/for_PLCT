...
%define RosPkgName      random-numbers

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS random-numbers package
...
%changelog
* Sun Dec 22 2024 Anas M'chichou anasarrak@erlerobotics.com - 1-None
