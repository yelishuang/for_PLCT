...
%define RosPkgName      tiago-moveit-config

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS tiago-moveit-config package

Url:            https://github.com/pal-robotics/tiago_simulation
License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-launch-pal
Requires: ros-%{ros_distro}-moveit-configs-utils
Requires: ros-%{ros_distro}-moveit-ros-control-interface
Requires: ros-%{ros_distro}-moveit-ros-move-group
Requires: ros-%{ros_distro}-moveit-kinematics
Requires: ros-%{ros_distro}-moveit-planners-ompl
Requires: ros-%{ros_distro}-moveit-ros-visualization
Requires: ros-%{ros_distro}-moveit-ros-perception
Requires: ros-%{ros_distro}-tiago-description
Requires: ros-%{ros_distro}-ros-workspace

BuildRequires: pal_module_cmake
...
%changelog
* Sun Dec 22 2024 TIAGo PAL support team tiago-support@pal-robotics.com - 1-None
