...
%define RosPkgName      boost-geometry-util

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Utility library for boost geometry
...
BuildRequires: ros-%{ros_distro}-ouxt-common
%endif
...
%changelog
* Sun Dec 22 2024 masaya ms.kataoka@gmail.com - 1-None
