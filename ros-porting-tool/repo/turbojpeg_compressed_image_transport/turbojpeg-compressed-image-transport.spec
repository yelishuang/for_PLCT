...
%define RosPkgName      turbojpeg-compressed-image-transport

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS turbojpeg-compressed-image-transport package
...
%changelog
* Sun Dec 22 2024 Daisuke Nishiamtsu border_goldenmarket@yahoo.co.jp - 1-None
