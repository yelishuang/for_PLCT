...
%define RosPkgName      rsl

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS Support Library

License:        BSD-3-Clause
Source0:        %{name}_%{version}.orig.tar.gz

Patch0: rsl-fix-Catch2-error.patch

Requires: eigen3-devel
Requires: fmt-devel
Requires: ros-%{ros_distro}-rclcpp
Requires: ros-%{ros_distro}-tcb-span
...
BuildRequires: ros-%{ros_distro}-tcb-span
