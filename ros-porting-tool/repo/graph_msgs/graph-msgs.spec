...
%define RosPkgName      graph-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        ROS messages for publishing graphs of different data types
...
%changelog
* Sun Dec 22 2024 Dave Coleman davetcoleman@gmail.com - 1-None
