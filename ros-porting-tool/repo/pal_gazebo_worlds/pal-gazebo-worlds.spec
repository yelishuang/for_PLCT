...
%define RosPkgName      pal-gazebo-worlds

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Simulation worlds for PAL robots.

Url:            https://github.com/pal-robotics/pal_gazebo_worlds/
License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz

Requires: pal_gazebo_worlds_private
