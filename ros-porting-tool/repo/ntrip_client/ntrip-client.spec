...
%define RosPkgName      ntrip-client

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        NTRIP client that will publish RTCM corrections to a ROS topic, and optionally subscribe to NMEA messages to send to an NTRIP server
...
Requires: ros-%{ros_distro}-rtcm-msgs
...
BuildRequires: ros-%{ros_distro}-rtcm-msgs
...
%changelog
* Sun Dec 22 2024 Rob Fisher rob.fisher@parker.com - 1-None
