...
%define RosPkgName      ur-msgs

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Message and service definitions for interacting with Universal Robots robot controllers.
...
%changelog
* Sun Dec 22 2024 G.A. vd. Hoorn g.a.vanderhoorn@tudelft.nl - 1-None
