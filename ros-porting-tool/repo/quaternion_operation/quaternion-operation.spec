...
%define RosPkgName      quaternion-operation

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        The quaternion_operation package

License:        Apache License 2.0
Source0:        %{name}_%{version}.orig.tar.gz

Requires: ros-%{ros_distro}-ament-cmake-auto
...
%changelog
* Sun Dec 22 2024 Masaya Kataoka ms.kataoka@gmail.com - 1-None
