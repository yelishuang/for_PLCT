...
%define RosPkgName      ur-client-library

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        1
Release:        None%{?dist}%{?release_suffix}
Summary:        Standalone C++ library for accessing Universal Robots interfaces. This has been forked off the ur_robot_driver.
...
%changelog
* Sun Dec 22 2024 Felix Exner feex@universal-robots.com - 1-None
